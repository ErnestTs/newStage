...
export default class Huashi extends Component {
    constructor(props){
        super(props)
        this.state= {
            routerData:[],
    ...
    scanCard(){
        ...
        if(huashiState !=0){
            ...
            cardInfo = {
                certNumber:CVR_IDCard.CardNo,
                partyName: CVR_IDCard.Name,
        ...
        Common.ajaxProcWithoutAsync("getVisitorSignOutByPhone", sendData, sessionStorage.token).done((data)=>{
			...
			if (arr.length !== 0) {
                ...
                let obj = {
                    ...
                    "idcardContent":{
                        "certNumber":this.state.cardInfo.certNumber||"",
                        "partyName":item.vname||"",
                        "address": this.state.cardInfo.address||"",
                        "photo": this.state.cardInfo.idcardPhoto||""
                    },
                    "tid":item.tid||"",
                    "vgroup":item.vgroup||"",
